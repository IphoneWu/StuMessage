...
<body>
<form action="/UpdateUser.action" method="post" class="definewidth m20">
    <table class="table table-bordered table-hover definewidth m10">
        <tr>
            <td width="10%" class="tableleft">登录名</td>
            <td>
                <input type="hidden" name="id" value="${user.id}">
                <input type="text" name="idcard" value="${user.idcard}" readonly/></td>
        </tr>
        <tr>
            <td class="tableleft">密码</td>
            <td><input type="text" name="passowrd" value="${user.passowrd}"/></td>
        </tr>
        <tr>
            <td class="tableleft"></td>
            <td>
                <button type="submit" class="btn btn-primary" onclick="ok()" type="button">保存</button>&nbsp;&nbsp;<button type="button" class="btn btn-success" name="backid" id="backid">返回列表</button>
            </td>
        </tr>
    </table>
</form>
