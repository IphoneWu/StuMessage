...
<body>
<form action="/addMark.action" method="post" class="definewidth m20">
<table class="table table-bordered table-hover m10">
    <tr>
        <td class="tableleft">学号</td>
        <td>
            <input type="text" name="sno" required/>
            <span class="alert-error">${stu_msg}</span>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <span class="alert-error">${cou_msg}</span>
        </td>
    </tr>
    <tr>
...
<script>
    $(function () {       
		$('#backid').click(function(){
				window.location.href="MarkList.action";
		 });
